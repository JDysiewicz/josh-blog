...
export default () => {
  return (
    <LightGlobal>
      <Navbar title="About" />
        <p>Hi, I'm <strong style={{color: "#1E90B3", fontSize: "2rem"}}>Joshua Dysiewicz</strong></p>
        
        <p>This is a blog about <strong style={{color: "#1E90B3", fontSize: "2rem"}}>JavaScript and React</strong></p>

        <p>I like to do <strong style={{color: "#1E90B3", fontSize: "2rem"}}>deep dives</strong> into how things are working under the hood</p>
