...
<div className="heading-header">Every function/class/component should do exactly one thing</div>
...
<div className="heading-header">Make big components from lots of smaller ones</div>
...
<div className="heading-header">Make classes substitutable for subclasses</div>
...
<div className="heading-header">Only pass a component props it needs</div>
...
<div className="heading-header">Always have high-level code interface with an abstraction, rather than an implementation detail</div>
