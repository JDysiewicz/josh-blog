...
readingTime: "📖 5 min"
spoiler: "An overview of how react works, culminating in a simple Counter app using a class component."
---

**NOTE** - This is a pretty long read. Don't feel like you have to read all of this at once - take breaks, go for a walk, etc. Between this, the *Component Lifecycle* post, and the *Hooks* post, there is about an **hour** of reading about React. However, I urge you to stick with it. React is hard, and to cover everything the framework has to offer in less than an hour of content is near impossible. This should, however, provide a great spring board for you to dive into other resources, or writing your own React project. Most importantly, enjoy the learning process - if you only care about an end result you will get frustrated early and often. There's a lot to learn with React, but you don't need all of it to be able to make something cool!

`js>let x = 5;`

## React Under the Hood
React is a javascript **framework**; it is a collection of files all packaged into a *library*. We import this library by writing 
```shell
