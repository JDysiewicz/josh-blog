...
Conversely, sometimes we may desire a *complex* solution over the easier solution. For instance, take the Two Sum problem. [https://leetcode.com/problems/two-sum/](https://leetcode.com/problems/two-sum/) We have an array of values, and we want to find a a pair of numbers in the array which sum to some value. [[33]](https://leetcode.com/problems/two-sum/)
