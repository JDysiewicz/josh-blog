...
<p className="info">The scope of a variable describes where the variable can be accessed from. Therefore, the scope of a function describes which variables it has access to. [[2]](https://en.wikipedia.org/wiki/Scope_(computer_science))</p>
